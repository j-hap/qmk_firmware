...
// defines combo for swapping the base layer based on matrix pins, not keycodes
const uint16_t PROGMEM toggle_base_layer_combo[] = {KC_G, KC_M, COMBO_END}; // pins are outer thumb keys on left half
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [DE_SYML_] = LAYOUT_split_3x6_3(
        DE_SECT,  DE_AT,    DE_ASTR,  DE_DLR,   DE_AMPR,  DE_GRV,     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        DE_DEG,   DE_TILD,  DE_MINS,  DE_EQL,   DE_UNDS,  DE_BSLS,    XXXXXXX,  KC_RCTL,  KC_RSFT,  KC_LALT,  KC_RGUI,  XXXXXXX,
    ...
    [DE_SYMR_] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX,  KC_RGUI,  KC_LALT,  KC_RSFT,  KC_RCTL,  XXXXXXX,    DE_SLSH,  DE_LPRN,  DE_RPRN,  DE_PIPE,  XXXXXXX,  XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    DE_PERC,  DE_LCBR,  DE_RCBR,  XXXXXXX,  XXXXXXX,  XXXXXXX,
                                      XXXXXXX,  XXXXXXX,  KC_TRNS,    XXXXXXX,  XXXXXXX,  XXXXXXX
    ),
    [EU_SYML_] = LAYOUT_split_3x6_3(
        EU_SECT,  EU_AT,    EU_ASTR,  EU_DLR,   EU_AMPR,  EU_GRV,     XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,
        EU_DEG,   EU_TILD,  EU_MINS,  EU_EQL,   EU_UNDS,  EU_BSLS,    XXXXXXX,  KC_RCTL,  KC_RSFT,  KC_LALT,  KC_RGUI,  XXXXXXX,
    ...
    [EU_SYMR_] = LAYOUT_split_3x6_3(
        ...
        XXXXXXX,  KC_LGUI,  KC_LALT,  KC_LSFT,  KC_LCTL,  XXXXXXX,    EU_SLSH,  EU_LPRN,  EU_RPRN,  EU_PIPE,  XXXXXXX,  XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,    EU_PERC,  EU_LCBR,  EU_RCBR,  XXXXXXX,  XXXXXXX,  XXXXXXX,
                                      XXXXXXX,  XXXXXXX,  KC_TRNS,    XXXXXXX,  XXXXXXX,  XXXXXXX
    ),
    ...
    [NAV_] = LAYOUT_split_3x6_3(
       XXXXXXX,       KC_F9,         KC_F10,        KC_F11,        KC_F12,        C(KC_X),              KC_PGUP,       KC_HOME,         KC_UP,        KC_END,       XXXXXXX,       KC_VOLU,
       XXXXXXX,       LGUI_T(KC_F5), LALT_T(KC_F6), LSFT_T(KC_F7), LCTL_T(KC_F8), C(KC_C),              KC_PGDN,       KC_LEFT,       KC_DOWN,      KC_RIGHT,       XXXXXXX,       KC_MUTE,
